...
export default function BookAppointment() {
    const { formState: { errors : appointmentErrors }, handleSubmit : appointmentHandleSubmit, watch : appointmentWatch, setValue : appointmentSetValue } = useForm<AppointmentFormData>({
        resolver: zodResolver(appointmentSchema)
    })
    const { register : appointmentRecordRegister, formState: { errors : appointmentRecordErrors }, handleSubmit : appointmentRecordHandleSubmit, watch : appointmentRecordWatch, setValue : appointmentRecordSetValue } = useForm<AppointmentRecordFormData>({
                        ...
                        return (
                            ...
                            >
                                <div className="flex flex-col items-center">
                                    ...
                                    <p
                                        className={`mt-3 text-sm font-medium text-center max-w-28
                                        ${
                                            completed
                                                ? "text-green-600"
                                                : active
