...
import useGetPatientNotifications from "../../../hooks/patient-notification/use-get-patient-notifications.hook";
...
import AppointmentModal from "../AppointmentHistory/AppointmentModal";
import { type Appointment } from "../../../types/appointment.type";
import useReadPatientNotification from "../../../hooks/patient-notification/use-read-patient-notification.hook";
import useReadAllPatientNotifications from "../../../hooks/patient-notification/use-read-all-patient-notifications.hook";

export default function PatientNotificationBell() {
    const readNotificationMutation = useReadPatientNotification();
    const readAllNotificationMutation = useReadAllPatientNotifications();
    ...
    const { data } = useGetPatientNotifications({
        ...
        if (data) {
            ...
            setNotifications((prev) =>
                pagination.pageIndex === 0
                    ...
                    : [...prev, ...data.patientNotifications]
            );
        }
